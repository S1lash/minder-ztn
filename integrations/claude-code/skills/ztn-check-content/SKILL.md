...
1. `zettelkasten/_system/POSTS.md` — published history (avoid repeats)
2. `zettelkasten/5_meta/PROCESSING_PRINCIPLES.md` — values profile for tone calibration
...
4. **Save draft** to `zettelkasten/6_posts/drafts/YYYYMMDD-draft-{topic-slug}.md`
...
Regenerate `zettelkasten/_system/views/CONTENT_OVERVIEW.md` — an auto-generated
